...
func ApplyTheme(hasDarkBG bool) {
	...
	ColorMuted = pick(lipgloss.Color("#6B6B80"), lipgloss.Color("#4A4A4A"))
	ColorDim = pick(lipgloss.Color("#7E7E96"), lipgloss.Color("#3A3A4A"))
	ColorSubtle = pick(lipgloss.Color("#484868"), lipgloss.Color("#8888AA"))

	ColorNormalText = pick(lipgloss.Color("#2E2E3E"), lipgloss.Color("#B0B0C0"))
	...
	ColorHelpSep = pick(lipgloss.Color("#8888A0"), lipgloss.Color("#555555"))
